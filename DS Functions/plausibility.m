...
%
% input:  keys -> labels of the classes and all the subsets of them in
...
% output: bel -> plausibility function values vector in in the order of the keys
...
if log2(len_m) > 7
     error('plausibility:classNumCheck', 'There are more than 7 classes')
end;
